...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:05:47 GMT -->
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
    <div class="themeControll ">
    	...
    	<h3 style=" color:#fff; font-size: 10px; line-height: 12px;" class="uppercase color-white text-center">
    		<a target="_blank" href="http://templatecycle.com/demo/bootclassified-5.1/template-index.php">  All
    		Pages</a> </h3>

    	<div class="linkinner linkScroll scrollbar ">
    		<a target="_blank" href="http://templatecycle.com/demo/bootclassified-5.1/template-index.php"> All Page Link</a>
    		<a target="_blank" href="index-v-2.php"> Home Page V2</a>
    		<a target="_blank" href="index-map.php"> Home with Map <span class="label label-success " style="font-size: 10px"><em>NEW</em></span></a>
    		<a target="_blank" href="blogs.php"> Blog</a>
    		<a target="_blank" href="blog-details.php"> Blog Details</a>
    		<a target="_blank" href="about-us.php"> about us</a>
    		<a target="_blank" href="account-archived-ads.php"> account archived</a>
    		<a target="_blank" href="account-close.php"> account close</a>
    		<a target="_blank" href="account-favourite-ads.php"> favourite ads</a>
    		<a target="_blank" href="account-home.php"> account home</a>
    		<a target="_blank" href="account-myads.php"> account my ads</a>
    		<a target="_blank" href="account-pending-approval-ads.php"> pending approval</a>
    		<a target="_blank" href="account-saved-search.php"> saved search</a>
    		<a target="_blank" href="ads-details.php"> ads details</a>
    		<a target="_blank" href="ads-details-2-vertical-thumb.php"> ads details 2</a>
    		<a target="_blank" href="ads-details-automobile.php"> Ads Details Automobile
    		</a>

    		<a> <strong>-- JOBS --</strong>    </a>

    		<a target="_blank" href="job-home.php"> Job Home </a>
    		<a target="_blank" href="job-list.php"> Job List </a>
    		<a target="_blank" href="job-details.php"> Job details </a>
    		<a target="_blank" href="job-login.php"> Job login </a>
    		<a target="_blank" href="job-post.php"> Job post </a>
    		<a target="_blank" href="job-signup.php"> Job signup </a>
    		<a> <strong>-- EVENTS --</strong>   <span class="badge badge-success " style="font-size: 10px"><em>NEW</em></span> </a>

    		<a target="_blank" href="event-home.php"> Event Home </a>
    		<a target="_blank" href="event-category.php"> Event List </a>
    		<a target="_blank" href="event-details.php"> Event details </a>

    		<a> <strong>-- OTHERS --</strong>    </a>

    		<a target="_blank" href="blank-page.php"> Blank Page</a>
    		<a target="_blank" href="category.php"> Category</a>
    		<a target="_blank" href="contact.php"> Contact</a>
    		<a target="_blank" href="forgot-password.php"> Forgot Password</a>
    		<a target="_blank" href="faq.php"> Faq</a>
    		<a target="_blank" href="form.php"> Form Elements</a>
    		<a target="_blank" href="post-ads.php"> Post Ads</a>
    		<a target="_blank" href="posting-success.php"> Posting Success</a>
    		<a target="_blank" href="signup.php"> Sign Up</a>
    		<a target="_blank" href="sub-category-sub-location.php"> Sub Category </a>
    		<a target="_blank" href="statements.php"> Order Statements  </a>
    		<a target="_blank" href="seller-profile.php"> Seller profile </a>
    		<a target="_blank" href="account-message-inbox.php"> Message Inbox <span class="badge badge-success " style="font-size: 10px"><em>NEW</em></span></a>
    		<a target="_blank" href="account-message-details.php"> Message Chat Box <span class="badge badge-success " style="font-size: 10px"><em>NEW</em></span></a>
    		<a target="_blank" href="account-message-compose.php"> Message compose <span class="badge badge-success " style="font-size: 10px"><em>NEW</em></span></a>
            ...
            <div class="col-xl-12 content-box ">
                <div class="row row-featured row-featured-category">
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/car-2.jpg" class="img-responsive"
                                                     alt="img">
                            <h6> Automobiles </h6></a>
                    </div>
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/mobile.jpg" class="img-responsive"
                                                     alt="img">
                            <h6> Mobiles </h6></a>
                    </div>

                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/tv.jpg" class="img-responsive" alt="img">
                            <h6>
                                Electronics </h6></a>
                    </div>
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="property-list.php"><img src="images/category/house.jpg" class="img-responsive"
                                                          alt="img">
                            <h6> Real Estate </h6></a>
                    </div>
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/camera.jpg" class="img-responsive"
                                                     alt="img">
                            <h6> Cameras </h6></a>
                    </div>

                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/fashion.jpg" class="img-responsive"
                                                     alt="img">
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/jobs.jpg" class="img-responsive"
                                                     alt="img">
                            <h6> Jobs </h6></a>
                    </div>

                    <div class="col-xl-2 col-md-3 col-sm-3 col-xs-4 f-category">
                        <a href="category.php"><img src="images/category/catalog.jpg" class="img-responsive"
                                                     alt="img">
                                ...
                                <div class="col-xl-12 tab-inner">
                                    <div class="row">
                                        <ul class="cat-list col-md-3  col-6 col-xxs-12">
                                            <li><a href="category.php">Atlanta</a>
                                            </li>
                                            <li><a href="category.php"> Dallas </a>
                                            </li>
                                            <li><a href="category.php"> New York </a>
                                            </li>
                                            <li><a href="category.php">Santa Ana/Anaheim </a>
                                            </li>
                                            <li><a href="category.php">Wichita </a>
                                            </li>
                                            <li><a href="category.php"> Anchorage </a>
                                            </li>
                                            <li><a href="category.php"> Miami </a>
                                            </li>
                                            <li><a href="category.php">Los Angeles</a>
                                            </li>
                                        </ul>
                                        <ul class="cat-list cat-list-border col-md-3  col-6 col-xxs-12">
                                            <li><a href="category.php">Boston </a>
                                            </li>
                                            <li><a href="category.php">Houston</a>
                                            </li>
                                            <li><a href="category.php">Salt Lake City </a>
                                            </li>
                                            <li><a href="category.php">Virginia Beach </a>
                                            </li>
                                            <li><a href="category.php"> San Diego </a>
                                            </li>
                                            <li><a href="category.php">San Francisco </a>
                                            </li>
                                            <li><a href="category.php">Tampa </a>
                                            </li>
                                            <li><a href="category.php"> Washington DC </a>
                                            </li>
                                        </ul>
                                        <ul class="cat-list cat-list-border col-md-3  col-6 col-xxs-12">
                                            <li><a href="category.php">Virginia Beach </a>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="inner-box-content">
                                <ul class="cat-list arrow">
                                    ...
                                    <li><a href="sub-category-sub-location.php"> Business Opportunities
                                        (4,974) </a>
                                    </li>
                                    <li><a href="sub-category-sub-location.php"> Community and Events (1,258) </a>
                                    </li>
                                    <li><a href="sub-category-sub-location.php"> Electronics and Appliances
                                        (1,578) </a></li>
                                    <li><a href="sub-category-sub-location.php"> Jobs and Employment (3,609) </a>
                                    </li>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:07:23 GMT -->
</html>
