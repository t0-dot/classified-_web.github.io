...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/property-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:20:23 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb" role="navigation" class="pull-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="property-list.php">Properties</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Search Results</li>
                    </ol>
                </nav>


                <div class="pull-right backtolist"><a href="property-list.php"> <i
                ...
                <div class="col-md-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        <h1 class="auto-heading"><span
                                class="auto-title left">Exclusive and modern luxury apartment </span> <span
                                    ...
                                    <div class="product-view-thumb-wrapper">
                                        ...
                                        <ul id="bx-pager" class="product-view-thumb">
                                            <li><a  data-slide-index="0" class="thumb-item-link"  href="#"><img
                                                    src="images/house/thumb/2.jpg" alt="img"/></a></li>
                                            <li  ><a data-slide-index="1" class="thumb-item-link" href="#"><img
                                                    src="images/house/thumb/4.jpg" alt="img"/></a></li>
                                            <li ><a data-slide-index="2" class="thumb-item-link"  href="#"><img
                                                    src="images/house/thumb/11.jpg" alt="img"/></a></li>
                                            <li ><a data-slide-index="3" class="thumb-item-link"  href="#"><img
                                                    src="images/house/thumb/14.jpg" alt="img"/></a></li>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/property-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:20:54 GMT -->
</html>
