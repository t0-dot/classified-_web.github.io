...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/account-message-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:45 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="col-md-9 col-lg-10">
                                    ...
                                    <div class="btn-group hidden-sm">
                                        ...
                                        <button type="button" class="btn btn-secondary dropdown-toggle"
                                            ...
                                            <span class="dropdown-menu-sort-selected">All</span>
                                        </button>

                                        <ul class="dropdown-menu dropdown-menu-sort" role="menu">
                                            <li class="dropdown-item active"><a >All</a>
                                            </li>
                                            <li class="dropdown-item"><a >None</a>
                                            </li>
                                            <li class="dropdown-item"><a >Read</a>
                                            </li>
                                            <li class="dropdown-item"><a >Unread</a>
                                            </li>
                                            <li class="dropdown-item"><a >Starred</a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <ul class="nav nav-pills  inbox-nav">
                                        <li class="active nav-item"><a  class="nav-link"> Inbox
                                        ...
                                        <div id="home">
                                            <div class="list-group">
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        <img src="images/users/6.jpg" alt="user">
                                                        <span class="name"> <i class="fa fa-circle online"></i>Parrish Zamora </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                    ...
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item seen">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        ...
                                                        <span class="name"> <i class="fa fa-circle online"></i>Calderon White </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                            Hi, how are you ? Donec vel purus eget dui pharetra rutrum 
                                                        </div>
                                                        <div class="time">2018-04-01 11:05pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        ...
                                                        <span class="name"> <i class="fa fa-circle offline"></i>Beatriz Norris </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                            Hi, how are you ? Ut rutrum dolor gravida dignissim molestie
                                                        </div>
                                                        <div class="time text-muted">2018-03-07 12:29pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        <img src="images/users/4.jpg" alt="user">
                                                        <span class="name"> <i class="fa fa-circle online"></i>Kerri Stevenson </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                            Hi, how are you ? Pellentesque aliquet lectus eleifend vulputate maximus
                                                        </div>
                                                        <div class="time text-muted">2018-01-05 09:26pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item seen">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        <img src="images/users/5.jpg" alt="user">
                                                        <span class="name"> <i class="fa fa-circle offline"></i>Good Moore </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                        ...
                                                        <div class="time text-muted">2018-02-01 07:23pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        <img src="images/users/6.jpg" alt="user">
                                                        <span class="name"> <i class="fa fa-circle online"></i>Baxter Henderson </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                        ...
                                                        <div class="time text-muted">2018-01-01 02:06pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
                                                ...
                                                <div class="list-group-item">
                                                    ...
                                                    <a href="account-message-details.php" class="list-box-user">
                                                        <img src="images/users/7.jpg" alt="user">
                                                        <span class="name"> <i class="fa fa-circle offline"></i>Angelita Potts </span>
                                                    </a>
                                                    <a href="account-message-details.php" class="list-box-content">
                                                        <span class="title">Is this item still available ?</span>
                                                        <div class="message-text  ">
                                                        ...
                                                        <div class="time text-muted">2018-03-21 04:21pm</div>
                                                    </a>
                                                    <div class="list-box-action">
                                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar"
                                                           title="Mark as Important "><i class="far fa-star"></i></a>
