...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/account-message-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:45 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <aside>
                        <div class="inner-box">
                            <div class="user-panel-sidebar">
                                ...
                                <!-- /.collapse-box  -->
                                <div class="collapse-box">
                                    <h5 class="collapse-title"> My Ads <a class="pull-right" aria-expanded="true"
                                                                          data-toggle="collapse"
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse show">
                                        <ul class="acc-list">
                                            ...
                                            <li><a href="account-favourite-ads.php"><i class="icon-heart"></i>
                                                Favourite ads <span class="badge badge-secondary">42</span> </a>
                                            </li>
                                            <li><a href="account-saved-search.php"><i class="icon-star-circled"></i>
                                                Saved search <span class="badge badge-secondary">42</span> </a>
                                            </li>
                                            <li class=""><a href="account-archived-ads.php"><i
                                                    class="icon-folder-close"></i> Archived ads <span
                                                    class="badge">12</span></a></li>
                                            <li><a href="account-pending-approval-ads.php"><i
                                                    class="icon-hourglass"></i> Pending approval <span
                                                    class="badge">42</span></a></li>
                                            <li class="active"><a href="account-message-inbox.php"><i
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2">
                                    <div class="btn-group hidden-sm">
                                        <a href="account-message-compose.php" class="btn btn-primary text-uppercase"
                                ...
                                <div class="col-md-9 col-lg-10 ">
                                    ...
                                    <div class="user-top">
                                        <p> <a href="#user"> <strong> Parrish Zamora </strong> </a>  <strong>Contact request for</strong> <a> Huawei Tablet T1
                                        </a></p>
                                    </div>

                                    <div class="message-tool-bar-right pull-right">
                                        <div class="btn-group btn-group-sm">
                                        <a data-toggle="tooltip" data-placement="top" class="markAsStar btn btn-secondary" title="" data-original-title="Mark as Important "><i class="far fa-star"></i></a>
                                        <a class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete ">
                                            <i class=" fas fa-trash"></i></a>
                                        <a class="markAsRead btn btn-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mark as read "> <i class=" fas fa-envelope"></i></a>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-2 hidden-sm">
                                    <ul class="nav nav-pills  inbox-nav">
                                        <li class="active nav-item"><a class="nav-link" href="account-message-inbox.php"> Inbox
                                    ...
                                    <div class="message-chat">
                                        <div class="message-chat-history">
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p>Qua effecerit praestare praefatio rea attentius scientiis. </p>
                                                        </div>
                                                        <span class="time-and-date">  1:20 PM    |    MAY 5 </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg">
                                                        <p>Terminari cau tantaeque opportune adjuvetis tot usurpabam formantur</p>
                                                    </div>
                                                    <span class="time-and-date"> 2:20 PM    |    MAY 6</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p>Ex augeatur vi efficere ac </p>
                                                        </div>
                                                        <span class="time-and-date"> 2:20 PM    |    MAY 6</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg">
                                                        <p>Dubium tes hic firmae est eos calida. Inter imo majus multo rum harum vitro</p>
                                                    </div>
                                                    <span class="time-and-date"> 11:01 AM    |    June 9</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p>de Finibus Bonorum et Malorum
                                                                </p>
                                                        </div>
                                                        <span class="time-and-date"> 11:01 AM    |    June 9</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg">
                                                        <p>praemissae satyriscos cogitantem et et. Cavillandi conjunctam credidisse de ex dissimilem gi integritas imaginandi</p>
                                                    </div>
                                                    <span class="time-and-date"> 4:52 PM    |    MAY 7</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        ...
                                                        <div class="msg">
                                                            <p>dubitandi infinitum ima cunctatus. Tertia</p>
                                                        </div>
                                                        <span class="time-and-date"> 5:02 PM    |    MAY 8</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg-img">
                                                        <img src="images/item/4.jpg" alt="img">
                                                    </div>

                                                    <div class="msg">
                                                        <p>sequitur tactiles bonitati</p>
                                                    </div>
                                                    <span class="time-and-date"> 6:30 PM    |    MAY 8</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p> ex hominem usitata apertum</p>
                                                        </div>
                                                        <span class="time-and-date"> 11:01 AM    |    June 9</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg">
                                                        <p>Tum judicium sua age automata eos quicquam</p>
                                                    </div>
                                                    <span class="time-and-date"> 11:01 AM    |    June 9</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p>nova mei eae quis. Ingeniosi vos separatum ita aliquando manifeste</p>
                                                        </div>
                                                        <span class="time-and-date"> 7:21 AM    |    MAY 9</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="chat-item object-me">
                                                <div class="chat-item-content">
                                                    <div class="msg">
                                                        <p>Cognitum immerito dumtaxat permulta</p>
                                                    </div>
                                                    <span class="time-and-date"> 11:02 AM    |    MAY 2</span></div>
                                            </div>
                                            <div class="chat-item object-user">
                                                ...
                                                <div class="chat-item-content">
                                                    <div class="chat-item-content-inner">
                                                        <div class="msg">
                                                            <p>distincta potuerunt dat sum fortassis lus</p>
                                                        </div>
                                                        <span class="time-and-date"> 9:02 AM    |    MAY 9</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="type-message">
                                            <div class="type-form">
                                                <input type="text" class="input-write form-control" placeholder="Type a message...">
                                                <div class="button-wrap">
                                                    <button class="btn btn-secondary" type="button"><i class="fas fa-paperclip" aria-hidden="true"></i></button>
                                                    <button class="btn btn-secondary" type="button"><i class="fas fa-paper-plane" aria-hidden="true"></i></button>
                                                </div>
                                            </div>
                                        </div>
