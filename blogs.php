...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/blogs.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:07:56 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="dtable hw100">
                <div class="dtable-cell hw100">
                    <div class="container text-center animated fadeInDown">
                        ...
                        <div class="row justify-content-md-center search-row animated fadeInUp">
                            <div class="col-xl-4 col-sm-offset-2 col-sm-4 search-col relative ">
                            ...
                            <div class="col-xl-4 col-sm-4 search-col">
                                <button class="btn btn-primary btn-search btn-block btn-gradient"><i class="icon-mail-1"></i><strong>
                        ...
                        <div class="blog-post-wrapper">
                            ...
                            <span class="info-row blog-post-meta"> <span class="date"><i class=" icon-clock"> </i> Today 1:21 pm </span>  -
                                ...
                                <span class="item-location"><i class="fa fa-comments"></i> Comments <a
                                        ...
                                        <div class="blog-post-content">
                                            <h2><a href="blog-details.php">Curabitur pretium tincidunt lacus</a></h2>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 clearfix blog-post-bottom">
                                                    <a class="btn btn-primary  pull-left" href="blog-details.php">More
                                                        info</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <span class="info-row blog-post-meta"> <span class="date"><i class=" icon-clock"> </i> Today 1:21 pm </span>  -
                                ...
                                <span class="item-location"><i class="fa fa-comments"></i> Comments <a
                                        ...
                                        <div class="blog-post-content">
                                            <h2><a href="blog-details.php">In enim justo, rhoncus ut, imperdiet a,
                                    ...
                                    <div class="blog-popular-content">
                                        <div class="item-list">
                                            ...
                                            <div class="col-sm-4 col-xs-4 no-padding photobox">
                                                <div class="add-image"><a href="ads-details.php"><img class="no-margin"
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/blogs.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:08:21 GMT -->
</html>
