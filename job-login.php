...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/job-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:09:40 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-5 login-box">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    <a href="account-home.php" class="btn btn-primary  btn-block">Submit</a>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="login-box-btm text-center">
                        <p> Don't have an account? <br>
                            <a href="job-signup.php"><strong>Sign Up !</strong> </a></p>
                    </div>
                </div>
            </div>
        </div>
