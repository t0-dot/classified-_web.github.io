...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/index-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:07:55 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="container text-center">
                    ...
                    <div class="row search-row animated fadeInUp">
                        ...
                        <div class="col-xl-4 col-sm-4 search-col relative"> <div class="search-col-inner"><i class="icon-docs icon-append"></i>
                            <div class="search-col-input">  <input type="text" name="ads" class="form-control has-icon"
                    ...
                    <div class="  box-title no-border">
                        <div class="inner">
                            <h2> <span class="icon-map"></span> <span>Browse by</span>
                                ...
                                REGION <a href="category.php" class="sell-your-item"> View more <i class="  icon-th-list"></i> </a></h2>
                        </div>
                    </div>
                    <div class="row">
...
<!-- MAP -->
<script src="assets/plugins/twism-master/dist/jquery.twism.js"></script>
<script>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/index-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:07:56 GMT -->
</html>
