...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="main-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation" class="pull-left">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="event-home.php"><i class="icon-home fa"></i></a></li>
                            <li class="breadcrumb-item"><a href="event-category.php">Events</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Search Results</li>
                        </ol>
                    </nav>


                    <div class="pull-right backtolist"><a href="event-category.php"> <i
        ...
        <div class="container">
                ...
                <div class="col-md-8 page-content col-thin-right">
                    ...
                    <div class="inner inner-box ads-details-wrapper event">
                        ...
                        <div class="Ads-Details">
                            <h4 class="text-uppercase"><strong>ABOUT THIS EVENT </strong></h4>
           ...
           "><strong>Event Overview</strong>
                                ...
                                <h4 class="text-uppercase"><strong>What to Bring </strong></h4>
                                <ul class="list-circle">
                                    <li>zzril delenit augue duis</li>
                                    <li>dolore te feugait nulla facilisi</li>
                                ...
                                <address>
                                    <p><a href="#"><strong>Rickey S Marino </strong></a> <br>
                                        3277 Horseshoe Lane<br>
                                        New York 75105<br>
                                        <br>
                                        Phone Number: +484-448-1749<br>

                                        E-Mail: info@RickeySMarino.com<br>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:29 GMT -->
</html>
