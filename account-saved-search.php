...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/account-saved-search.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:08:38 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="collapse-box">
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse show">
                                        <ul class="acc-list">
                                            ...
                                            <li class="active"><a href="account-saved-search.php"><i
                                                    class="icon-star-circled"></i> Saved search <span
                                                    class="badge">42</span> </a></li>
                                            <li><a href="account-archived-ads.php"><i class="icon-folder-close"></i>
                                                Archived ads <span class="badge badge-secondary">12</span></a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <ul class="list-group list-group-unstyle">
                                    <li class="list-group-item active"><a href="#" class=""> <span> AMSUNG GALAXY MOBILE...</span>
                                    ...
                                    <li class="list-group-item "><a href="#" class="">
                                        <span> AMSUNG GALAXY MOBILE...</span> </a></li>
                                    <li class="list-group-item "><a href="#" class="">
                                        <span> AMSUNG GALAXY MOBILE...</span> </a></li>
                                    <li class="list-group-item "><a href="#" class="">
                                        <span> AMSUNG GALAXY MOBILE...</span> </a></li>
                                    ...
                                    <div class="item-list">
                                        ...
                                        <div class="col-sm-8 add-desc-box">
                                            <div class="ads-details">
                                                <h5 class="add-title"><a href="ads-details.php"> SAMSUNG GALAXY S CORE
                                                    Duos </a></h5>
                                                <span class="info-row"> <span class="add-type business-ads tooltipHere"
                                                        ...
                                                        class="item-location"><i class="fa fa-map-marker-alt"></i> New York </span> </span>
                                            </div>
                                        </div>
                                        <!--/.add-desc-box-->
