...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/ads-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:08:38 GMT -->
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
    				...
    				<ul class="nav navbar-nav ml-auto navbar-right">
    					...
    					<li class="dropdown no-arrow nav-item"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
    						...
    						<ul
    							...
    							<li class="active dropdown-item"><a href="account-home.php"><i class="icon-home"></i> Personal Home

    							</a>
    							</li>
    							<li class="dropdown-item"><a href="account-myads.php"><i class="icon-th-thumb"></i> My ads </a>
    							</li>
    							<li class="dropdown-item"><a href="account-favourite-ads.php"><i class="icon-heart"></i> Favourite ads </a>
    							</li>
    							<li class="dropdown-item"><a href="account-saved-search.php"><i class="icon-star-circled"></i> Saved search

    							</a>
    							</li>
    							<li class="dropdown-item"><a href="account-archived-ads.php"><i class="icon-folder-close"></i> Archived ads

    							</a>
    							</li>
    							<li class="dropdown-item"><a href="account-pending-approval-ads.php"><i class="icon-hourglass"></i> Pending

    								approval </a>
    							</li>
    							<li class="dropdown-item"><a href="statements.php"><i class=" icon-money "></i> Payment history </a>
    							</li>
    							<li class="dropdown-item"><a href="login.php"><i class=" icon-logout "></i> Log out </a>
    							</li>
    						</ul>
    					</li>
    ...
    <?php 
     $disabled="";
            ...
            $required="required";
            if (isset($_GET['adid'])) {
                $sql = mysql_query("select * from tb1adds where ad_status='Y' and aid='" . $_GET['adid'] . "'");
                          ...
                          if( $con1=mysql_query("select * from tb1users where uid ='".$row['ad_user']."'")){
                                if($row1=mysql_fetch_array($con1)){
                                 $getseller_name= $row1['seller_name'];
                                  ...
                                  $getseller_dym=$row1['seller_regdate'];
            ...
            echo "<script>alert('Invalid Ad');window.location.href='index.php';</script>";
        }
            }
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="pull-right backtolist"><a href="sub-category-sub-location.php"> <i
            ...
            <div class="row">
                <div class="col-md-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        <h2><?php if(isset($_GET['adid'])){ echo $getad_title;} ?>
                        ...
                        <span class="info-row"> <span class="date"><i class=" icon-clock"> </i> Today 1:21 pm </span> - <span
                                class="category"><?php if(isset($_GET['adid'])){ echo $getcategory;} ?> </span>- <span class="item-location"><i
                                class="fa fa-map-marker-alt"></i> <?php if(isset($_GET['adid'])){ echo $getseller_loc;}?></span> </span>
                        <div class="item-slider">
                            <h1 class="pricetag"><?php if(isset($_GET['adid'])){ echo$getprice; }?></h1>
                            <ul class="bxslider">
                                <li><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[0] . "'/>";
                                                        }
                                                        ?></li>
                                <li><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[1] . "'/>";
                                                        }
                                                        ?></li>
                                <li><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[2] . "'/>";
                                                        }
                                                        ?></li>
                            </ul>
                            <div id="bx-pager">
                                <a class="thumb-item-link" data-slide-index="0" href="#"><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[0] . "'/>";
                                                        }
                                                        ?></a>
                                <a class="thumb-item-link" data-slide-index="1" href="#"><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[1] . "'/>";
                                                        }
                                                        ?></a>
                                <a class="thumb-item-link" data-slide-index="2" href="#"><?php
                                                        if (isset($_GET['adid'])) {
                                                            echo "<img src='fileupload/" . $arr_of_images[3] . "'/>";
                                                        }
                                                        ?></a>
                            </div>
                        </div>
                        ...
                        <div class="Ads-Details">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <aside class="panel panel-body panel-details">
                                        <ul>
                                            <li>
                                                <p class=" no-margin "><strong>Price:</strong><?php  if (isset($_GET['adid'])) {echo $getprice;} ?></p>
                                            </li>
                                            <li>
                                                <p class="no-margin"><strong>Type:</strong><?php  if (isset($_GET['adid'])) {echo $getad_type;} ?></p>
                                            </li>
                                            <li>
                                                <p class="no-margin"><strong>Location:</strong><?php  if (isset($_GET['adid'])) {echo $getseller_loc;} ?> </p>
                                            </li>
                                            <li>
                            ...
                            <div class="content-footer text-left"><a class="btn  btn-default" data-toggle="modal"
                                    ...
                                    class=" icon-mail-2"></i> Send a message </a> <a class="btn  btn-info"><i
                                            class=" icon-phone-1"></i> <?php if(isset($_GET['adid'])){echo $getseller_phone;}?> </a></div>
                        </div>
                    </div>
                    <!--/.ads-details-wrapper-->
                        ...
                        <div class="card card-user-info sidebar-card">
                            <div class="block-cell user">
                                ...
                                <div class="cell-content">
                                    ...
                                    <span class="name"><a href="seller-profile.php"><?php if(isset($_GET['adid'])){echo $getseller_name;} ?></a></span>
                            ...
                            <div class="card-content">
                                <div class="card-body text-left">
                                    <div class="grid-col">
                                        ...
                                        <div class="col to">
                                            <span><?php if(isset($_GET['adid'])){echo $getseller_city_loc;}?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid-col">
                                        ...
                                        <div class="col to">
                                            <span><?php if(isset($_GET['adid'])){echo $getseller_dym;} ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="ev-action">
                                    ...
                                    <a class="btn  btn-info btn-block">
                                        <i class=" icon-phone-1"></i><?php if(isset($_GET['adid'])){echo $getseller_phone;}?> </a>
                                </div>
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/ads-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:08:51 GMT -->
</html>
