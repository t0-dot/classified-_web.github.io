...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/seller-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:38 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="seller-profile-img">
                                            <a><img src="images/users/1.jpg" class="img-responsive thumbnail" alt="img"> </a>
                                        </div>
                                    </div>
                                        <div class="col-md-9">
                                            ...
                                            <div class="seller-social-list">
                                                ...
                                                <ul class="share-this-post">
                                                    ...
                                                    <li><a class="google-plus"><i class="fab fa-google-plus"></i></a>
                                                    </li>
                                                    <li><a class="facebook"><i class="fab fa-facebook"></i></a>
                                                    </li>
                                                    <li><a><i class="fab fa-twitter"></i></a>
                                                    </li>
                                                    <li><a class="pinterest"><i class="fab fa-pinterest"></i></a>
                                                    </li>
                    ...
                    <div class="row">
                        <div class="col-sm-9 col-thin-left page-content ">
                                    ...
                                    <div class="item-list">
                                        <div class="row">
                                            <div class="col-md-2 no-padding photobox">
                                                <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span>  <a href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00015.jpg" alt="img"></a>
                                                </div>
                                            </div>
                                            <!--/.photobox-->
                                 ...
                                 <span class="info-row"> <span class="add-type business-ads tooltipHere" data-toggle="tooltip" data-placement="right" title="Business Ads">B </span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 no-padding photobox">
                                                <div class="add-image"><span class="photo-count"><i
                                                        class="fa fa-camera"></i> 2 </span> <a href="ads-details.php"><img
                                                    ...
                                                    <h5 class="add-title"><a href="ads-details.php">
                                                        Sony Xperia dual sim 100% brand new </a></h5>
                                                                        <span class="info-row"> <span class="add-type business-ads tooltipHere"
                                                                                ...
                                                                                class="fa fa-map-marker-alt"></i> New York </span> </span></div>
                                            </div>
                                            <!--/.add-desc-box-->
                                            <div class="col-md-3 text-right  price-box">
                                    ...
                                    <div class="item-list">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> Google drops Nexus 4 </a></h5>
                                                                        <span class="info-row"> <span class="add-type business-ads tooltipHere"
                                                                                                      data-toggle="tooltip" data-placement="right"
                                                                                                      title="Business Ads">B </span> <span class="date"><i
                                                                                class=" icon-clock"> </i> Today 1:21 pm </span> - <span
                                    ...
                                    <div class="item-list">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> Samsung Galaxy S Dous (Brand
                                    ...
                                    <div class="item-list">
                                        <div class="row"><div class="col-md-2 no-padding photobox">
                                            ...
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> MSI GE70 Apache Pro-061 17.3"
                                    ...
                                    <div class="item-list">
                                        <div class="row"><div class="col-md-2 no-padding photobox">
                                            <div class="add-image"><span class="photo-count"><i
                                                    class="fa fa-camera"></i> 2 </span> <a href="ads-details.php"><img
                                                    class="thumbnail no-margin" src="images/item/tp/Image00021.jpg"
                                                    alt="img"></a></div>
                                        </div>
                                            <!--/.photobox-->
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> Apple iPod touch 16 GB 3rd
                                                        Generation </a></h5>
                                                                        <span class="info-row"> <span class="add-type business-ads tooltipHere"
                                                                                                      data-toggle="tooltip" data-placement="right"
                                                                                                      title="Business Ads">B </span> <span class="date"><i
                                    ...
                                    <div class="item-list">
                                        <div class="row"><div class="col-md-2 no-padding photobox">
                                            ...
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> Google drops Nexus 4 by $100,
                                    ...
                                    <div class="item-list">
                                        <div class="row"><div class="col-md-2 no-padding photobox">
                                            <div class="add-image"><span class="photo-count"><i
                                                    class="fa fa-camera"></i> 2 </span> <a href="ads-details.php"><img
                                                    class="thumbnail no-margin"
                                                    src="images/item/tp/Image00023.jpg"
                                                    alt="img"></a></div>
                                        </div>
                                            <!--/.photobox-->
                                            <div class="col-sm-7 add-desc-box">
                                                <div class="ads-details">
                                                    <h5 class="add-title"><a href="ads-details.php"> Fully functional iPhone 5s 32gb  </a></h5>
                                                    <span class="info-row"> <span class="add-type business-ads tooltipHere"
                                                                                  data-toggle="tooltip" data-placement="right"
                                                                                  title="Private Ads">P </span> <span class="date"><i
                                                            class=" icon-clock"> </i> Today 1:15 pm </span> - <span
                                                            class="category">Electronics </span>- <span class="item-location"><i
                                                            class="fa fa-map-marker-alt"></i> New York </span> </span></div>
                                            </div>
                                            <!--/.add-desc-box-->
                                            <div class="col-md-3 text-right  price-box">
                                                <h2 class="item-price"> $ 35 </h2>
                                                <a class="btn btn-default  btn-sm make-favorite"> <i class="fa fa-heart"></i> <span>Save</span>
                                                </a></div>
                                            <!--/.add-desc-box-->
                                        </div>
                                            ...
                                            <div class="adds-wrapper row no-margin">
                                                <div class="item-list">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7 add-desc-box">
                                                            <div class="ads-details">
                                                                <h5 class="add-title"><a href="ads-details.php"> Google drops Nexus 4 by $100, offers 15 day price
                                                ...
                                                <div class="item-list">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding photobox">
                                                            <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                                                                    href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00015.jpg" alt="img"></a>
                                                            </div>
                                                        </div>
                                                        <!--/.photobox-->
                                                        <div class="col-sm-7 add-desc-box">
                                                ...
                                                <div class="item-list">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 text-right  price-box">
                                                            <h2 class="item-price"> $ 150 </h2>
                                                            <a class="btn btn-danger  btn-sm make-favorite"> <i class="fa fa-certificate"></i> <span>Urgent</span> </a> <a
                                                ...
                                                <div class="item-list">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding photobox">
                                                            <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                                                                    href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00008.jpg" alt="img"></a>
                                                            </div>
                                                        </div>
                                                        <!--/.photobox-->
                                                        <div class="col-sm-7 add-desc-box">
                                                ...
                                                <div class="item-list">
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding photobox">
                                                            <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                                                                    href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00014.jpg" alt="img"></a>
                                                            </div>
                                                        </div>
                                                        <!--/.photobox-->
                                                        <div class="col-sm-7 add-desc-box">
                                                            <div class="ads-details">
                                                                <h5 class="add-title"><a href="ads-details.php"> Samsung Galaxy S Dous (Brand New/ Intact Box) With 1year
                                                                    Warranty </a></h5>
                                                                <span class="info-row"> <span class="add-type business-ads tooltipHere" data-toggle="tooltip"
                                                                                              data-placement="right" title="Business Ads">B </span> <span class="date"><i
                                                                        class=" icon-clock"> </i> Today 1:21 pm </span> - <span class="category">Electronics </span>- <span
                                                ...
                                                <div class="item-list">
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding photobox">
                                                            <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                                                                    href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00003.jpg" alt="img"></a>
                                                            </div>
                                                        </div>
                                                        <!--/.photobox-->
                                                        <div class="col-sm-7 add-desc-box">
                                                            <div class="ads-details">
                                                                <h5 class="add-title"><a href="ads-details.php"> MSI GE70 Apache Pro-061 17.3" Core i5-4200H/8GB DDR3/NV
                                                ...
                                                <div class="item-list">
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding photobox">
                                                            <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a
                                                                    href="ads-details.php"><img class="thumbnail no-margin" src="images/item/tp/Image00022.jpg" alt="img"></a>
                                                            </div>
                                                        </div>
                                                        <!--/.photobox-->
                                                        <div class="col-sm-7 add-desc-box">
                                                            <div class="ads-details">
                                                                <h5 class="add-title"><a href="ads-details.php"> Apple iPod touch 16 GB 3rd Generation </a></h5>
                                                                <span class="info-row"> <span class="add-type business-ads tooltipHere" data-toggle="tooltip"
                                                                                              data-placement="right" title="Business Ads">B </span> <span class="date"><i
                                                                        class=" icon-clock"> </i> Today 1:21 pm </span> - <span class="category">Electronics </span>- <span
                                                                        class="item-location"><i class="fa fa-map-marker-alt"></i> London </span> </span></div>
                            ...
                            <div class="post-promo text-center">
                                ...
                                <a href="post-ads.php" class="btn btn-lg btn-border btn-post btn-danger">Post a Free
                                    Ad </a></div>
                            <!--/.post-promo-->
...
<!-- Mirrored from templatecycle.com/demo/bootclassified-5.1/dist/seller-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Mar 2021 09:13:45 GMT -->
</html>
